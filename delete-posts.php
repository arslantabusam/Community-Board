...
require_once "header.php";
    if(isset($_POST['delete']))
    {
        ...
        {
            // successfull message
            echo "<div class='text-center fw-bold p-4 display-6 p-3 mb-2 bg-secondary text-white'>This Post Has Been Deleted. <br></div> <div class='text-center'> <a href='user_posts.php'>Click here</a> to to view yours posts.</div>";
        }
        else
        {    
